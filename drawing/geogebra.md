...
Use `geogebra` for plotting function or more accurate illustration. For example, draw exactly angle of 60 degree.
...
* Also use geogebra, then inkscape: https://www.youtube.com/watch?v=-WWeOlN-wck
