# Conclusion on Drawing Math Illustration

## Drawing conceptual illustration to explain math problem: Use localhost's `inkscape` + localhost's $\LaTeX$

Use [inkscape and $\LaTeX$](./inkscape_latex_local.md).

## $\LaTeX$'s TikZ can draw conceptual math illustration, and also plot graph from data
