...
\begin{tcblisting}{listing only,title=２つの図を横に並べる}
    \begin{figure}
...
\begin{tcblisting}{title=\texttt{b} を指定}
    \begin{minipage}[b]{0.3\columnwidth}
        \centering
        \begin{tikzpicture}
            \draw (0,0) rectangle(2,2);
...
\begin{tcblisting}{title=\texttt{c} を指定}
...
\begin{tcblisting}{title=\texttt{t} を指定}
...
\begin{tcblisting}{title=ベースラインを変更}
    \begin{minipage}[t]{0.3\columnwidth}
        \centering
...
\begin{tcblisting}{title=マトリックス状に並べる}
    \begin{tabular}{rc}
...
\begin{tcblisting}{title=マトリックス状に配置}
    \begin{tikzpicture}
...
\begin{tcblisting}{title=各セルの中央に配置}
    \begin{tikzpicture}
        \matrix[row sep=0.1cm,column sep=0.1cm,
...
\begin{tcblisting}{title=セルごとに位置合わせ}
    \begin{tikzpicture}
        \matrix[row sep=0.1cm,column sep=0.1cm] {
...
\begin{tcblisting}{title=\texttt{shift} オプションで調整}
    \begin{tikzpicture}
        \begin{scope}
            \draw (0,0) rectangle(2,2);
            \draw[fill=white] (1,1) circle[radius=1];
